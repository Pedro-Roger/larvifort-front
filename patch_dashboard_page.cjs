    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', overflowY: 'auto', backgroundColor: '#f3f4f6', padding: '24px 32px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: 16, marginBottom: 24 }}>
        <div style={kpiStyle}>
          ...
          <div>
            <div style={{ fontSize: 12, color: '#6b7280', fontWeight: 500 }}>Vendas do Mês</div>
        ...
        <div style={kpiStyle}>
          ...
          <div>
            <div style={{ fontSize: 12, color: '#6b7280', fontWeight: 500 }}>Volume (PLs)</div>
        ...
        <div style={kpiStyle}>
          ...
          <div>
            <div style={{ fontSize: 12, color: '#6b7280', fontWeight: 500 }}>Pedidos (Aberto)</div>
        ...
        <div style={kpiStyle}>
          ...
          <div>
            <div style={{ fontSize: 12, color: '#6b7280', fontWeight: 500 }}>Pedidos em Risco</div>
        ...
        <div style={kpiStyle}>
          ...
          <div>
            <div style={{ fontSize: 12, color: '#6b7280', fontWeight: 500 }}>Receita Prevista</div>
        ...
        <div style={kpiStyle}>
          ...
          <div>
            <div style={{ fontSize: 12, color: '#6b7280', fontWeight: 500 }}>Integração AquaFort</div>
